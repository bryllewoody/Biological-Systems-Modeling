...
# --- Exercise 5-5: Tabulation and Plots ---
print("\n=== Exercise 5-5 ===")
print("t\tAnalytical\tEuler\t\tImproved Euler\tRK4")

# Collect data for CSV and plots
t_data = list(range(31))
analytical_data = []
euler_data = []
improved_euler_data = []
rk4_data = []
...
for t in t_data:
    ...
    print(f"{t:2d}\t{a:.5f}\t\t{e:.5f}\t\t{h:.5f}\t\t{r:.5f}")
...
print("\nExercise 5-5 output files created:")
print("1. exercise_5_5_results.csv - All numerical results")
print("2. exercise_5_5_comparison.png - Solution comparison plot")
print("3. exercise_5_5_errors.png - Error analysis plot")